...
# Set H and V total values 864x625x50.00hz = 27Mhz (inc. blank/sync)
sudo i2cset -y -r 1 0x17 0x01 0x60 b
sudo i2cset -y -r 1 0x17 0x02 0x13 b
sudo i2cset -y -r -m 0x7f 1 0x17 0x03 0x27 b
